...
print '33848 -<a class="butAction"  href="#" onclick="OuvreModale(this, 33848)">Modifier</a> '."\n";
print '<p>';
print '33850 - <a class="butAction"  href="#" onclick="OuvreModale(this,33850)">Modifier</a> '."\n";
print '<p>';
print '8<a class="butAction"  href="#" onclick="OuvreModale(this, 0)">Creer</a> '."\n";
	 ...
	 function OuvreModale(o, id){
		...
		let fmodalDialog = document.getElementById("fmodalDialog");
		 if (typeof fmodalDialog.showModal === "function") {
			...
			document.getElementById("titreech").value=titreech;
...
function Constitution($wsuivi) 
{
	...
	$ListContenu[] = array ("label"=>"Titre", "type" =>"text",   "name"=>"titreech" , "id"=>"titreech" , "value"=>$text );
	if (empty($wsuivi)) $text = '';
	else $text = $wsuivi->desc;
